...
QMAKE_CXXFLAGS_WARN_ON += -Wall -Waddress -Woverloaded-virtual -Wshadow -Wconversion \
                          -Wextra -Wunused-parameter -Wunused-function -Wno-unknown-pragmas

INCLUDEPATH += \
      deps/include

LIBS += \
    -Wl,-rpath -Wl,deps/lib \
    -Ldeps/lib  \
    -lCoinDB	\
    -lCoinQ	\
    -lCoinCore	\
